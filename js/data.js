const LINES = {
  ...
  RRTS:{color:"#006064",textColor:"#fff",shortName:"RRTS",name:"Namo Bharat RRTS",route:"Sarai Kale Khan ↔ Meerut South",stations:["Sarai Kale Khan","Jangpura RRTS","New Ashok Nagar","Anand Vihar ISBT","Sahibabad","Ghaziabad","Guldhar","Duhai","Duhai Depot","Muradnagar","Modi Nagar South","Modi Nagar North","Meerut South"]},
...
const LANDMARKS = {
  ...
  "muradnagar":"Muradnagar","duhai":"Duhai",
  "guldhar":"Guldhar","modi nagar":"Modi Nagar South"
};

const HINDI_NAMES = {
  "Rajiv Chowk":"राजीव चौक","Kashmere Gate":"कश्मीरी गेट",
  "New Delhi":"नई दिल्ली","Chandni Chowk":"चाँदनी चौक",
  "Central Secretariat":"केंद्रीय सचिवालय","AIIMS":"एम्स",
  "Hauz Khas":"हौज़ खास","Lajpat Nagar":"लाजपत नगर",
  "Karol Bagh":"करोल बाग","INA":"आई.एन.ए.","Saket":"साकेत",
  "Huda City Centre":"हुडा सिटी सेंटर","Dwarka Sec-21":"द्वारका सेक्टर-21",
  "Dwarka":"द्वारका","Botanical Garden":"बोटैनिकल गार्डन",
  "Anand Vihar ISBT":"आनंद विहार आई.एस.बी.टी.",
  "Vaishali":"वैशाली","Kaushambi":"कौशाम्बी",
  ...
  "Mandi House":"मण्डी हाउस","ITO":"आई.टी.ओ.",
  "Azadpur":"आज़ादपुर","Vishwavidyalaya":"विश्वविद्यालय",
  "Rajouri Garden":"राजौरी गार्डन","Pitampura":"पीतमपुरा",
  "Rohini West":"रोहिणी वेस्ट","Rohini East":"रोहिणी ईस्ट",
  "Meerut South":"मेरठ साउथ","Meerut Central":"मेरठ सेंट्रल",
  "Meerut North":"मेरठ नॉर्थ","Modipuram":"मोदीपुरम",
  "Modipuram Depot":"मोदीपुरम डिपो","Ghaziabad":"ग़ाज़ियाबाद",
  "Sahibabad":"साहिबाबाद","Sarai Kale Khan":"सराय काले खान",
  "Adarsh Nagar":"आदर्श नगर","Jahangirpuri":"जहाँगीरपुरी",
  "Samaypur Badli":"समयपुर बादली","Lal Quila":"लाल किला",
  "Jama Masjid":"जामा मस्जिद","Begumpul":"बेगमपुल",
  "Shatabdi Nagar":"शताब्दी नगर","Rithani":"रिठानी",
  "Partapur":"पार्तापुर","Brahampuri":"ब्रह्मपुरी",
  "Bhaisali":"भैसाली","MES Colony":"एम.ई.एस. कॉलोनी",
  "Daurli":"दौरली","Muradnagar":"मुरादनगर",
  "Duhai":"दुहाई","Guldhar":"गुलधर",
  "Modi Nagar South":"मोदी नगर साउथ","Modi Nagar North":"मोदी नगर नॉर्थ",
  "Najafgarh":"नजफगढ़","Sikanderpur":"सिकंदरपुर",
  "MG Road":"एम.जी. रोड","IFFCO Chowk":"इफको चौक",
  "Escorts Mujesar":"एस्कॉर्ट्स मुजेसर","Old Faridabad":"पुराना फरीदाबाद",
  "Tughlakabad":"तुगलकाबाद","Nehru Place":"नेहरू प्लेस",
  "Kalkaji Mandir":"कालकाजी मंदिर","Kalindi Kunj":"कालिंदी कुंज",
  "Pari Chowk":"परी चौक","Greater Kailash":"ग्रेटर कैलाश",
  "Sarojini Nagar":"सरोजिनी नगर","Welcome":"वेलकम",
  "Shahdara":"शाहदरा","Dilshad Garden":"दिलशाद गार्डन",
  "Vivek Vihar":"विवेक विहार","Janakpuri West":"जनकपुरी वेस्ट",
  "Uttam Nagar East":"उत्तम नगर ईस्ट","Tagore Garden":"टैगोर गार्डन",
  "Moti Nagar":"मोती नगर","Patel Nagar":"पटेल नगर",
  "Rajendra Place":"राजेंद्र प्लेस","Jhandewalan":"झण्डेवाला",
  "Indraprastha":"इंद्रप्रस्थ","Akshardham":"अक्षरधाम",
  "Mayur Vihar Phase-1":"मयूर विहार फेज-1",
  "Noida Sector 18":"नोएडा सेक्टर 18","Palam":"पालम",
  "Vasant Vihar":"वसंत विहार","Munirka":"मुनिरका",
  "Green Park":"ग्रीन पार्क","Malviya Nagar":"मालवीय नगर",
  "Qutab Minar":"क़ुतुब मीनार","Chhatarpur":"छतरपुर",
  "Guru Dronacharya":"गुरु द्रोणाचार्य","Shiv Vihar":"शिव विहार",
  "Majlis Park":"मजलिस पार्क","Gokulpuri":"गोकुलपुरी",
  "New Ashok Nagar":"न्यू अशोक नगर","Jangpura RRTS":"जंगपुरा आर.आर.टी.एस."
};
...
// -------------------------------------------------------
// REAL FARE SYSTEM
// Delhi Metro: DMRC official slabs (distance based, avg 1.2km per stop)
// RRTS: NCRTC official slabs (avg 2.5km per stop, min Rs20 max Rs210)
// Meerut Metro: affordable local fares (avg 1.5km per stop)
// Airport Express: fixed premium fare
// -------------------------------------------------------
function calculateFare(stops, lineType) {
  var isRRTS = (lineType === 'RRTS');
  var isMeerut = (lineType === 'MeerutMetro');
  var isAirport = (lineType === 'Orange');

  if (isAirport) {
    // Airport Express fixed fares
    if (stops <= 1) return { fare: 10, note: 'Airport Express' };
    if (stops <= 2) return { fare: 20, note: 'Airport Express' };
    if (stops <= 3) return { fare: 40, note: 'Airport Express' };
    if (stops <= 4) return { fare: 50, note: 'Airport Express' };
    return { fare: 60, note: 'Airport Express' };
  }

  if (isRRTS) {
    // RRTS NCRTC real fare slabs
    // Min Rs20, Max Rs210 (Sarai Kale Khan to Modipuram)
    var km = stops * 2.5;
    if (km <= 4)   return { fare: 20,  note: 'Namo Bharat Standard' };
    if (km <= 8)   return { fare: 40,  note: 'Namo Bharat Standard' };
    if (km <= 15)  return { fare: 60,  note: 'Namo Bharat Standard' };
    if (km <= 22)  return { fare: 80,  note: 'Namo Bharat Standard' };
    if (km <= 30)  return { fare: 100, note: 'Namo Bharat Standard' };
    if (km <= 40)  return { fare: 120, note: 'Namo Bharat Standard' };
    if (km <= 50)  return { fare: 150, note: 'Namo Bharat Standard' };
    if (km <= 65)  return { fare: 180, note: 'Namo Bharat Standard' };
    return         { fare: 210, note: 'Namo Bharat Standard' };
  }

  if (isMeerut) {
    // Meerut Metro affordable local fares
    var km = stops * 1.5;
    if (km <= 3)   return { fare: 10, note: 'Meerut Metro' };
    if (km <= 6)   return { fare: 20, note: 'Meerut Metro' };
    if (km <= 12)  return { fare: 30, note: 'Meerut Metro' };
    if (km <= 18)  return { fare: 40, note: 'Meerut Metro' };
    return         { fare: 50, note: 'Meerut Metro' };
  }

  // Delhi Metro DMRC real fare slabs
  var km = stops * 1.2;
  if (km <= 2)   return { fare: 10, note: 'Delhi Metro' };
  if (km <= 5)   return { fare: 20, note: 'Delhi Metro' };
  if (km <= 12)  return { fare: 30, note: 'Delhi Metro' };
  if (km <= 21)  return { fare: 40, note: 'Delhi Metro' };
  if (km <= 32)  return { fare: 50, note: 'Delhi Metro' };
  return         { fare: 60, note: 'Delhi Metro' };
}
